...
export const SignupPage = () => {
  ...
  const form = useForm<SignupFormValues>({
    ...
    validate: {
      firstName: (value) => (value.trim().length >= 2 ? null : 'Имя должно содержать минимум 2 символа'),
      lastName: (value) => (value.trim().length >= 2 ? null : 'Фамилия должна содержать минимум 2 символа'),
  ...
  return (
    <Container size="xs" py="xl">
      ...
      >
        <form onSubmit={form.onSubmit(({ firstName, lastName, email, password }) => {
